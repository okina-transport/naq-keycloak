...
<html>
<head>
    <title>Welcome to Kefsdfsdfdsycloak</title>
...
<div class="wrapper">
    <div class="content">
        ...
        <h1>Welcome to Keyfsdfsdfsdcloak</h1>
        ...
        <#if bootstrap && localUser>
            <form method="post">
                <p>
                    <label for="username">Userndfsdfsdame</label>
                    <input id="username" name="username" />
                </p>

                <p>
                    <label for="password">Passwfsdfsdord</label>
